...
class SlidingButton : FrameLayout {
    ...
    constructor(
        ...
        context.theme.resolveAttribute(com.google.android.material.R.attr.colorAccent, colorAccent, true)
        ...
        trackBackground = arr.getDrawable(R.styleable.SlidingButton_sliding_trackBackground)
            ?: ContextCompat.getDrawable(context, R.drawable.gradient_ackground)
